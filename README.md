...
The Geometry Vector Operations library provides a set of functionalities for performing vector operations in 3D geometry.

## Description

The Geometry Vector Operations library implements various operations on 3D vectors, including addition, subtraction, normalization, dot product, cross product, distance calculation, angle calculation, and projection.

## Features

- **Vector Operations:** Perform basic vector operations such as addition, subtraction, multiplication, and division.
- **Magnitude Calculation:** Calculate the magnitude of a vector.
- **Normalization:** Normalize a vector to unit length.
- **Dot Product:** Calculate the dot product of two vectors.
- **Cross Product:** Calculate the cross product of two vectors.
- **Distance Calculation:** Calculate the distance between two vectors or between a vector and a plane.
- **Angle Calculation:** Calculate the angle between two vectors, between a vector and an axis, or between a vector and a plane.
- **Projection:** Project a vector onto another vector or onto a plane.

## Usage

To use the Geometry Vector Operations library, follow these steps:
...
```bash
git clone https://github.com/AayushJoshiCCTECH/GeomRepo
